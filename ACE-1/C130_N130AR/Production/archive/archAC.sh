...
#   Project   #
###############
setenv PROJECT "ACE-1"
setenv YEAR 1995
setenv PLATFORM "C130_N130AR"
setenv ARCHIVE_SCRIPT "/h/eol/srunkel/aircraft_projects/Configuration/scripts/archAC.py"
setenv CS_LOCATION "/glade/campaign/eol/archive/"
setenv EMAIL "srunkel@ucar.edu"
setenv projectlower "ace-1"
...
#Raw 2D data
$ARCHIVE_SCRIPT oap /scr/raf_Raw_Data/$PROJECT/oap 2d $CS_LOCATION$YEAR/ $EMAIL

#$ARCHIVE_SCRIPT LRT/V1.1 /scr/raf/Prod_Data/$PROJECT/V1.1 nc /net/archive/data/ $EMAIL
