...
# */1 * * * * /home/local/Systems/scripts/send_biff_to_ingest.cron.py
#
import os
import sys
import glob
...
# NaContour_03-Jul-2014_7-7-33.png
files=glob.glob('NaContour*.png')
for file in files:

    # Copy the files to the web dir so they can be viewed in a browser 
    # onboard the aircraft.
    os.system('/bin/cp '+file+' /var/www/html/lidar/.');
