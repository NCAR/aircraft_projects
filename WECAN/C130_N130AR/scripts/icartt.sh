...
#sed -i -e 's/CVINLET,",CVI inlet flag, 0=CVI, 1=Total/CVINLET,",CVI inlet flag, 0=CVI, 1=Total, 2=SDI/g' ${DAT}/WECAN-CVI*_C130_*RC.ict
#sed -i -e 's/DATA_INFO: data reported in ambient condition, ambient temperature and pressure are given for conversion to STP (273.15K and 1013 mb)/DATA_INFO:CVCWCC and CONCU_CVIU reported in ambient units, use ambient temperature and pressure from aircraft file for conversion to STP (273.15K and 1013 mb)/g' ${DAT}/WECAN-CVI*_C130_*RC.ict
#sed -i -e 's/Romashkin, Pavel/Toohey, Darin/g' ${DAT}/WECAN-CVI*_C130_*RC.ict
#sed -i -e 's/Pavel Romashkin/Darin Toohey/g' ${DAT}/WECAN-CVI*_C130_*RC.ict
