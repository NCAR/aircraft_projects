...
prefix           = 'alternate.satellite.'
postfix      = '.png'
osm_file_name    = "alternate.satellite.png"
...
# Get the latest image and its label
  try:
    ...
    if os.path.isdir(catalog_ingest_dir):
        ...
        #     satellite.alt-satellite-1.<datetime>.composite-1.png
        ...
        if match:
            dest_file = catalog_ingest_dir+"/satellite.alt-satellite-1." + match.group(1) + ".composite-1.png"
