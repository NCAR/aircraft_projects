...
logfile_raf="/tmp/udp2sql_raf.log"
logfile_non="/tmp/udp2sql_non.log"
...
/opt/local/bin/udp2sql -R < /dev/null > $logfile_raf 2>&1 &
/opt/local/bin/udp2sql -N < /dev/null > $logfile_non 2>&1 &
