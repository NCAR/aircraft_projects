...
function acMap() {
	...
	this.getIconUpdate = function() {
		...
		OpenLayers.Request.GET({ 
			url: '/cgi-bin/flight_data/osm_latlon.pl?'+Math.random(), 
	...
	this.applyIconUpdate = function(response) {
		...
		this.planeLayer.icon.attributes.description = "Position:<br>"+h.lat+"&deg;N, "+h.lon+"&deg;E<br><br>Heading: "+(h.head%360)+"&deg;<br>Altitude: "+Math.round(h.alt*3.2808)+"ft";
