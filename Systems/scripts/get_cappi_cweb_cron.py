...
prefix           = 'radar.NEXRAD_3D_mosaic.'
postfix		 = '.??kft_CAPPI.png' 
osm_file_name    = "latest_cappi.png"
min_of_imgs      = 10

# End of Initialization section

print "Starting get_cappi_cweb.py for getting " + image_type + " imagery"
...
#  Turns out that for Cappi, we don't give a crappi about region
