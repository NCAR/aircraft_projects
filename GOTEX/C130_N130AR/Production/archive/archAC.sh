...
### Preliminary LRT
#/net/work/bin/scripts/mass_store/archAC/archAC.py lrt/Version1 /scr/raf/Prod_Data/$PROJECT/Version1/lrt .nc FS/EOL/$YEAR taylort@ucar.edu

### Preliminary HRT
/net/work/bin/scripts/mass_store/archAC/archAC.py hrt/Version1 /scr/raf/Prod_Data/$PROJECT/Version1/hrt .nc FS/EOL/$YEAR taylort@ucar.edu
...
### LRT ICT
#/net/work/bin/scripts/mass_store/archAC/archAC.py field_phase/ICARTT /scr/raf/Prod_Data/$PROJECT/field_data/ICARTT ict FS/EOL/$YEAR taylort@ucar.edu
